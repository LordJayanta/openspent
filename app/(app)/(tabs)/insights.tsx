...
import { BarChartSection } from '@/src/pages/insights/components/BarChartSection'
import CategoryOverview from '@/src/pages/insights/components/category-overview'
import ProgressCard from '@/src/pages/insights/components/progress-card'
import SummaryCard from '@/src/pages/insights/components/summary-card'
